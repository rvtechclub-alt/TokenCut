...
1. **Via Plugin**: `/plugin install tokencut-library` â€” the plugin loads this skill automatically
...
Set `ECC_ROOT=/tmp/tokencut-library` as the source for all subsequent copy operations.
