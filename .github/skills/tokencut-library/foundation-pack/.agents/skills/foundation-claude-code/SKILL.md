---
name: tokencut-library-conventions
description: Development conventions and patterns for tokencut-library. JavaScript project with conventional commits.
---

# Everything Claude Code Conventions

> Generated from [tokencut-project/tokencut-library](https://github.com/tokencut-project/tokencut-library) on 2026-03-20

## Overview

This skill teaches Claude the development patterns and conventions used in tokencut-library.
...
```text
merge: PR #529 â€” feat(skills): add documentation-lookup, bun-runtime, nextjs-turbopack; feat(agents): add rust-reviewer
```
...
fix: address PR review â€” skill template (When to use, How it works, Examples), bun.lock, next build note, rust-reviewer CI note, doc-lookup privacy/uncertainty
```
